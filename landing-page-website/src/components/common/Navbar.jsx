...
const Navbar = () => {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'h-20 bg-black/85 shadow-lg backdrop-blur-md' : 'h-[90px] bg-black/60 backdrop-blur-md border-b border-white/10'
      }`}>
